...
<div ng-app="KnobDemoApp">tsano
    <div ng-controller="knobCtrl">
        <ui-knob value="MaxOnValue" options="MaxOnOptions"></ui-knob>
        <ui-knob value="MaxOffValue" options="MaxOffOptions"></ui-knob>
    </div>
</div>
<script type="text/javascript">
	////////////////////////////
	//begin ng-knob.js include
	/////////////////////////////
